...
<div class="container">
    <div class="row mt-4">
        <div class="col-md-4">
            <a href="../admin/inventario.php" class="text-decoration-none">
        ...
        <div class="col-md-4">
            <a href="../admin/reservas.php" class="text-decoration-none">
    ...
    <div class="alert alert-info mt-2">
        <h5>👁️ Bienvenido, Supervisor <strong><?php echo htmlspecialchars($_SESSION['nombre']); ?></strong></h5>
