...
// Traer reservas según el rol
if ($rol_id == 1 || $rol_id == 3) {
    $sql  = "SELECT r.*, u.nombre_completo FROM reservas r
...
$insumos_disponibles = [];
if ($rol_id == 2) {
    $stmt_ins = $conn->query("SELECT id, nombre, cantidad FROM insumos WHERE estado = 'disponible' AND cantidad > 0 ORDER BY nombre ASC");
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto">
                ...
                <?php elseif ($rol_id == 3): ?>
                    <li class="nav-item"><a class="nav-link" href="supervisor.php"><i class="bi bi-house"></i> Inicio</a></li>
                    <li class="nav-item"><a class="nav-link" href="inventario.php"><i class="bi bi-box-seam"></i> Inventario</a></li>
                    <li class="nav-item"><a class="nav-link active" href="reservas.php"><i class="bi bi-calendar-check"></i> Reservas</a></li>
                <?php else: ?>
                    <li class="nav-item"><a class="nav-link" href="residente.php"><i class="bi bi-house"></i> Inicio</a></li>
                    <li class="nav-item"><a class="nav-link" href="inventario.php"><i class="bi bi-box-seam"></i> Inventario</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card shadow mb-4 border-0">
                ...
                <div class="card-body">
                    <form action="acciones_reservas.php" method="POST">
                        ...
                        <tr class="<?php echo $fila; ?>">
                            ...
                            <td>
                                <?php if ($rol_id == 1): ?>
                                    ...
                                    <a href="acciones_reservas.php?accion=aprobar&id=<?php echo $r['id']; ?>"
                                ...
                                <?php elseif ($rol_id == 2): ?>
                                    ...
                                    <a href="acciones_reservas.php?accion=cancelar&id=<?php echo $r['id']; ?>"
