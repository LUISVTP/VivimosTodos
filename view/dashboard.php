                                        ...
                                        <form action="acciones_usuario.php" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label fw-semibold">Perfil / Rol</label>
                                                    <select name="rol_id" class="form-select" required>
                                                        <option value="1" <?php if ((int) $fila['rol_id'] === 1) echo 'selected'; ?>>Administrador</option>
                                                        <option value="2" <?php if ((int) $fila['rol_id'] === 2) echo 'selected'; ?>>Residente</option>
                                                        <option value="3" <?php if ((int) $fila['rol_id'] === 3) echo 'selected'; ?>>Supervisor</option>
                                                    </select>
                                                </div>
                                            </div>
