...
// Traer insumos registrados
$sql     = "SELECT * FROM insumos ORDER BY fecha_registro DESC";
$insumos = $conn->query($sql)->fetchAll();

// Traer catálogo predefinido para el select
$catalogo = $conn->query("SELECT * FROM catalogo_insumos ORDER BY nombre ASC")->fetchAll();
?>
<!DOCTYPE html>
<html lang="es">
<head>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-1">
                            ...
                            <a href="acciones_inventario.php?accion=eliminar_catalogo&id=<?php echo $c['id']; ?>"
